...
QtCore.QDir.addSearchPath('icons', resource_path('icon'))
...
"}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("icons:/bank.png"))
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icon/code.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
