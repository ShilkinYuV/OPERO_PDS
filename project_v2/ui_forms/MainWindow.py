...
"")
        ...
        self.pbutton_settings = QtWidgets.QPushButton(self.widget_2)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.pbutton_settings.setFont(font)
        self.pbutton_settings.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbutton_settings.setObjectName("pbutton_settings")
        self.horizontalLayout.addWidget(self.pbutton_settings)
        self.pbutton_load_log = QtWidgets.QPushButton(self.widget_2)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pbutton_load_log.setFont(font)
        self.pbutton_load_log.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbutton_load_log.setObjectName("pbutton_load_log")
        self.horizontalLayout.addWidget(self.pbutton_load_log)
        self.pbutton_check_vpn = QtWidgets.QPushButton(self.widget_2)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pbutton_check_vpn.setFont(font)
        ...
        self.pbutton_make_archive = QtWidgets.QPushButton(self.widget_2)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pbutton_make_archive.setFont(font)
        self.pbutton_make_archive.setObjectName("pbutton_make_archive")
        self.horizontalLayout.addWidget(self.pbutton_make_archive)
        ...
        font.setBold(False)
        font.setWeight(50)
        self.pbutton_show_about.setFont(font)
        self.pbutton_show_about.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pbutton_show_about.setObjectName("pbutton_show_about")
        self.horizontalLayout.addWidget(self.pbutton_show_about)
...
"}")
        ...
        self.lbl_password_days = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_password_days.setFont(font)
        self.lbl_password_days.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.lbl_password_days.setObjectName("lbl_password_days")
        self.verticalLayout_3.addWidget(self.lbl_password_days)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pbutton_make_archive.setText(_translate("MainWindow", "Архивация"))
        ...
        self.lbl_password_days.setText(_translate("MainWindow", "Дней до смены пароля:"))
